...
<template>  
  <div class="bg-white min-h-screen overflow-x-hidden max-[874px]:py-5">
    <header class="w-full">
      <div class="grid grid-cols-3 max-[874px]:grid-cols-2 items-center gap-2.5 w-full px-20">
        ...
        <div class="flex justify-center py-13.25 items-center max-[874px]:hidden">
          <nav>
            <RouterLink class="pr-9 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway] max-[874px]:hidden" to="/">HOME</RouterLink>
            <RouterLink class="pr-9 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway] max-[874px]:hidden" to="/news">NEWS</RouterLink>
            <RouterLink class="pr-9 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway] max-[874px]:hidden" to="/events">EVENTS</RouterLink>
            <RouterLink class="pr-9 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway] max-[874px]:hidden" to="/network">NETWORK</RouterLink>
            <!-- <RouterLink class="pr-9 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway]" to="/media">MEDIA</RouterLink> -->
          </nav>
        </div>
          <div class="flex justify-end items-center">
            <div class="flex items-center border border-blue rounded-lg overflow-hidden">
              ...
              <button class="flex items-center gap-2 text-blue hover:text-orange text-sm lg:text-lg font-[Raleway] px-4 lg:px-6 py-1 lg:py-2">
