<template>
    <div class="grid grid-cols-12 gap-2.5">
        <div class="col-start-1 col-span-6">
            <h2 class="capitalize font-[raleway] text-4xl text-black font-semibold mb-5"><span class="text-orange">w</span>hat’s happening right now in the world of business</h2>
        </div>
