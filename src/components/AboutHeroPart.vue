<template>
    <div class="grid grid-cols-12 gap-2.5 sm:pt-20 pt-5">
        <h1
        ...
        <p class="col-start-1 lg:col-end-8 col-end-10 text-base md:text-lg font-[raleway] font-base pt-7.5 text-blue">{{ t.AboutText }}</p>
    </div>
</template>
