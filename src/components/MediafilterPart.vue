<template>
    <div class="news-header py-4 font-[raleway]">
        <div class="flex items-baseline flex-col lg:flex-row justify-between">
          <h3 class="text-blue font-[raleway] font-bold text-4xl uppercase  lg:whitespace-nowrap">
              Media Channel
          </h3>
          <div class="flex flex-row gap-2">
            <div class="flex items-center gap-4">
              ...
              <div class="relative flex items-center">
                <input v-model="store.searchQuery" type="text" class="sm:min-w-67.75 w-full max-w-67.75  h-7.5 bg-white border border-black focus:outline-none focus:border-black-70 rounded">
