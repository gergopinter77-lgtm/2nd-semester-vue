export const translations = {
    en: {
        ...
        WhatWeDo: 'Meet leaders and specialists from across the region. Share experience, build relationships, and put new knowledge to work — across industries and roles.',
    ...
    da: {
        ...
        WhatWeDo: 'Mød ledere og specialister fra hele regionen. Del erfaringer, opbyg relationer, og brug ny viden – på tværs af brancher og roller.',
    ...
    de: {
        ...
        WhatWeDo: 'Treffen Sie Führungskräfte und Spezialisten aus der gesamten Region. Teilen Sie Erfahrungen, bauen Sie Beziehungen auf und setzen Sie neues Wissen um – branchenübergreifend und in verschiedenen Rollen.',
